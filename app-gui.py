...
class StartPage(tk.Frame):
        ...
        def __init__(self, parent, controller):
            ...
            render = PhotoImage(file='appui.png')
            ...
            label = tk.Label(self, text="              ", font=self.controller.title_font, fg="#263942")
            label.grid(row=6,column=1, sticky="ew")
            label = tk.Label(self, text="      ", font=self.controller.title_font,
                             fg="#263942")
            label.grid(row=8, column=1, sticky="ew")
            label = tk.Label(self, text="                             ",
                             font=self.controller.title_font,
                             fg="#263942")
            label.grid(row=9, column=1, sticky="ew")
            label = tk.Label(self, text="              ",
                             font=self.controller.title_font,
                             fg="#263942")
            ...
            button3.grid(row=4, column=0, ipady=3, ipadx=32)
...
class PageTwo(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.dropdown.grid(row=0, column=1, ipadx=30, padx=50, pady=30)
        self.buttoncanc.grid(row=1, ipadx=10, ipady=8, column=0, pady=20)
        self.buttonext.grid(row=1, ipadx=10, ipady=8, column=1, pady=20)
...
class PageTwo(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        self.dropdown["menu"].config(bg="lightgrey")
        self.buttonext = tk.Button(self, text="Next", command=self.nextfoo, fg="#ffffff", bg="#263942")
        self.dropdown.grid(row=0, column=1, ipadx=20, padx=24, pady=30)
        self.buttoncanc.grid(row=1, ipadx=10, ipady=8, column=0, pady=20)
        self.buttonext.grid(row=1, ipadx=10, ipady=8, column=1, pady=20)
...
class PageFour(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="Face Recognition And Control Robot Arm", font='Helvetica 16 bold')
        label.grid(row=0,column=0, sticky="ew")
        button1 = tk.Button(self, text="Face Recognition And Control Robot Arm", command=self.openwebcam, fg="#ffffff", bg="#263942")
        ...
        button4.grid(row=3,column=0, sticky="ew", ipadx=5, ipady=4, padx=10, pady=10)
